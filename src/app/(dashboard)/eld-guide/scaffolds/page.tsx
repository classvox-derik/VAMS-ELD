...
3. What was Section 3 about? _______________`}
        ...
        <ScaffoldSection
          ...
          exampleAfter={`<p>Photosynthesis is the process by which plants make their own food using sunlight. Plants take in carbon dioxide from the air through tiny holes in their leaves called stomata.</p><br/><p>They also absorb water from the soil through their roots. The chlorophyll in the leaves captures energy from sunlight.</p><br/><p>This energy is used to combine the carbon dioxide and water to make glucose, which is a type of sugar the plant uses for food. Oxygen is released as a byproduct, which is what humans and animals breathe.</p>`}
