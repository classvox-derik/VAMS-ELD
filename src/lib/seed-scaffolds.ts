...
const defaultScaffolds = [
  {
    ...
    ai_prompt_template:
      'Color code specific word types throughout the ENTIRE document, in EVERY paragraph from start to finish. Wrap nouns with <span style="background-color: #90CAF9;">word</span> (blue), verbs with <span style="background-color: #AED581;">word</span> (green), adjectives with <span style="background-color: #FFCC80;">word</span> (orange), and vocabulary bank words with <span style="background-color: #FFF176;">word</span> (yellow). If a word is both a vocabulary bank word and another part of speech, use yellow (vocabulary bank takes priority). Every paragraph must have at least one highlighted element. Do NOT skip any paragraph. ONLY use the colors listed here — do NOT use any other highlight colors.\n\nPART-OF-SPEECH IDENTIFICATION RULES (follow these strictly):\nNOUNS (blue #90CAF9): Only highlight words functioning as nouns in context — people, places, things, or ideas. Do NOT highlight words that look like nouns but function as adjectives (e.g., "school" in "school bus"). Gerunds are nouns ONLY when they are the subject or object (e.g., "Swimming is fun"), NOT when describing ongoing action (e.g., "She is swimming").\nVERBS (green #AED581): Highlight action words and linking verbs. Include the FULL verb phrase (e.g., "was running", "had been eaten"). Do NOT highlight infinitives used as nouns.\nADJECTIVES (orange #FFCC80): Highlight words that describe or modify a noun, including predicate adjectives. Do NOT highlight adverbs. Articles (a, an, the) are NOT adjectives.\nVOCABULARY WORDS (yellow #FFF176): Highlight academic or challenging Tier 2/3 vocabulary words.\n\nCRITICAL: Identify each word\'s part of speech based on how it FUNCTIONS in the sentence, not just what it looks like. Many English words can be multiple parts of speech depending on context.\n\nInclude a color key at the end of the document.',
    is_default: true,
  },
  {
    name: "Chunking",
