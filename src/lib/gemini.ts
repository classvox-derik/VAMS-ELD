...
1. **highlight_range**: Find exact text in the original and apply a background color.
   ...
   - background_color must be a hex color string matching ONLY the colors specified in the scaffold instructions above (do NOT use colors for word types that were not requested)
