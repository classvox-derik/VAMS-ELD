...
> **Setup Check:** If the Terminology Guide below still contains `[Add word]` / `[Add replacement]` rows, follow the First-Use Setup in `SKILL.md` to prompt the user for their terminology preferences before writing any copy.
